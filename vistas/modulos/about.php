  <div class="">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-12">
          <img class="img-responsive" src="vistas/assets/images/img-01.jpg">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section-container">
    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2">
      <h1 class="text-center">Nuestro proceso de creación </h1>
      <ol class="features">
        <li>
